...
Sub Class_Globals
	...
	Private BT_ResetPassword As Button
...
Private Sub B4XPage_Created (Root1 As B4XView)
	Root = Root1
	Root.LoadLayout("forgot_password")
...
Private Sub BT_ResetPassword_Click
	ClearFields
	B4XPages.ShowPageAndRemovePreviousPages("verification")
End Sub
