...
public class forgotpasswordpage extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    private static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.vehicle.tracker.forgotpasswordpage");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.vehicle.tracker.forgotpasswordpage.class).invoke(this, new Object[] {null});
        else
...
public anywheresoftware.b4a.objects.ButtonWrapper _bt_resetpassword = null;
...
public ResumableSub_B4XPage_CloseRequest(com.vehicle.tracker.forgotpasswordpage parent) {
this.parent = parent;
}
com.vehicle.tracker.forgotpasswordpage parent;
...
_root = _root1;
 //BA.debugLineNum = 17;BA.debugLine="Root.LoadLayout(\"forgot_password\")";
_root.LoadLayout("forgot_password",ba);
...
public String  _bt_resetpassword_click() throws Exception{
 //BA.debugLineNum = 38;BA.debugLine="Private Sub BT_ResetPassword_Click";
 //BA.debugLineNum = 39;BA.debugLine="ClearFields";
_clearfields();
 //BA.debugLineNum = 40;BA.debugLine="B4XPages.ShowPageAndRemovePreviousPages(\"verifica";
_b4xpages._showpageandremovepreviouspages /*String*/ (ba,"verification");
...
_et_email = new anywheresoftware.b4a.objects.EditTextWrapper();
 //BA.debugLineNum = 5;BA.debugLine="Private BT_ResetPassword As Button";
_bt_resetpassword = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 6;BA.debugLine="Private LB_Login As Label";
_lb_login = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 7;BA.debugLine="End Sub";
return "";
}
public String  _clearfields() throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Private Sub ClearFields";
 //BA.debugLineNum = 49;BA.debugLine="ET_Email.Text = \"\"";
...
public String  _login_click(Object _tag) throws Exception{
 //BA.debugLineNum = 43;BA.debugLine="Private Sub Login_Click (Tag As Object)";
 //BA.debugLineNum = 44;BA.debugLine="ClearFields";
_clearfields();
 //BA.debugLineNum = 45;BA.debugLine="B4XPages.ShowPageAndRemovePreviousPages(\"login\")";
